...
def get_embedding(text: str):
    try:
        # st_model.encode() otomatis mengembalikan numpy array.
        # Karena inputnya berupa string tunggal, hasilnya sudah otomatis 1-D (flat).
        embedding = st_model.encode(text)
        
        # Ubah numpy array menjadi list bawaan Python
